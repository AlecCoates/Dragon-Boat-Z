...
public class BoatTest {
    ...
    public void testCheckIfInLane() {
        //Test left of lane
        Boat testBoat = new Boat(15, 5, 15, lanes, 1, "A");
        testBoat.setStats(100, 5, 10, 7);
        testBoat.threshold = 1;
        ...
        //Test on left edge
        testBoat = new Boat(15, 5, 15, lanes, 1, "A");
        testBoat.setStats(100, 5, 10, 7);
        testBoat.threshold = 1;
    ...
    public void testGetProgress() {
        //Test Before Finish
        Boat testBoat = new Boat(14, 5, 15, lanes, 1, "A");
        ...
        //Test After Finish
        testBoat = new Boat(16, 5, 15, lanes, 1, "A");
        assertEquals(1f, testBoat.getProgress(15), 0.0002);
    }
